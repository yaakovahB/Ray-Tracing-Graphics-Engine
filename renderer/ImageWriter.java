...
public class ImageWriter {
	private int nX; //number of pictures per row
	private int nY; //number of pixels per column

	//folder that picture is saved in
	...
	/**
	 * @brief  write a color of a specific pixel into pixel color matrix
